...
const OPTIONS = [
  ...
  "Finding patterns from my symptoms",
  "Having real data to bring to my doctor",
  "Predicting my cycle",
  "Seeing what's actually working",
  "Knowing fertile window to conceive",
];
...
export default function Onboard4({ onBack, onFinish }: Onboard4Props) {
      ...
      <motion.div className="ob2-card" variants={cardVariants} initial="hidden" animate="visible">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="ob1-question-block">
            <h2 className="ob1-question">What type of progress would you like to see?</h2>
