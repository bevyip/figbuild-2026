...
const FLOWERS: FlowerConfig[] = [
  ...
  },
  {
    ...
    style: { left: -20, top: 81, width: 92, height: 95 },
    rotate: -173.18,
    innerWidth: 82,
    innerHeight: 86,
    floatY: [-6, 8, -6],
...
const OPTIONS = [
  "Exhaustion no matter the sleep",
  "Acne break outs around cycle",
  "Feel anxious or low to energy",
  "Feeling bloated every meal",
  "Hair is thinning",
  "My cycle is unpredictable or missing",
  "Weight that won't budget",
...
export default function Onboard2({ onBack, onNext }: Onboard2Props) {
      ...
      <motion.div className="ob2-card" variants={cardVariants} initial="hidden" animate="visible">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="ob1-question-block">
            <h2 className="ob1-question">What does your body do?</h2>
